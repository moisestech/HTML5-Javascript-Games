...
function selectCard() {
	...
	// the browsed will animate the styles between current state and card-flipped state.
...
function shuffle() {
	...
	// the sort function determined by either possitive number and negative number.
	// Math.random() range from 0 - 1, 0.5 - Math.random() results either positive or negative number.
